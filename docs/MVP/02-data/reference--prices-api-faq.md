...
> Source: [https://www.alchemy.com/docs/reference/prices-api-faq.md](https://www.alchemy.com/docs/reference/prices-api-faq.md)

# Prices API FAQ

> Commonly asked questions when using Alchemy's Prices API for fungible token prices.
