...
> Source: [https://www.alchemy.com/docs/reference/nft-api-endpoints/nft-api-endpoints/nft-api-v-2-methods-older-version/get-nf-ts-for-collection.md](https://www.alchemy.com/docs/reference/nft-api-endpoints/nft-api-endpoints/nft-api-v-2-methods-older-version/get-nf-ts-for-collection.md)

# getNFTsForCollection

> For the complete documentation index, see [llms.txt](/docs/llms.txt).

GET https://eth-mainnet.g.alchemy.com/nft/v2/{apiKey}/getNFTsForCollection

Gets all NFTs for a given NFT contract.

Reference: https://www.alchemy.com/docs/reference/nft-api-endpoints/nft-api-endpoints/nft-api-v-2-methods-older-version/get-nf-ts-for-collection
...
```bash
curl --request GET \
  --url https://eth-mainnet.g.alchemy.com/nft/v2/docs-demo/getNFTsForCollection
```
...
fetch('https://eth-mainnet.g.alchemy.com/nft/v2/docs-demo/getNFTsForCollection', options)
  .then(res => res.json())
...
```java
HttpResponse<String> response = Unirest.get("https://eth-mainnet.g.alchemy.com/nft/v2/docs-demo/getNFTsForCollection")
  .asString();
```
...
var options = new RestClientOptions("https://eth-mainnet.g.alchemy.com/nft/v2/docs-demo/getNFTsForCollection");
...
```yaml
path: /v2/{apiKey}/getNFTsForCollection
method: GET
operation:
