...
> Source: [https://www.alchemy.com/docs/reference/nft-api-endpoints/nft-api-endpoints/nft-api-v-2-methods-older-version/compute-rarity.md](https://www.alchemy.com/docs/reference/nft-api-endpoints/nft-api-endpoints/nft-api-v-2-methods-older-version/compute-rarity.md)

# computeRarity

> For the complete documentation index, see [llms.txt](/docs/llms.txt).

GET https://eth-mainnet.g.alchemy.com/nft/v2/{apiKey}/computeRarity

Computes the rarity of each attribute of an NFT.

Reference: https://www.alchemy.com/docs/reference/nft-api-endpoints/nft-api-endpoints/nft-api-v-2-methods-older-version/compute-rarity
...
```bash
curl --request GET \
  --url 'https://eth-mainnet.g.alchemy.com/nft/v2/docs-demo/computeRarity?contractAddress=0xe785E82358879F061BC3dcAC6f0444462D4b5330&tokenId=44'
```
...
```java
HttpResponse<String> response = Unirest.get("https://eth-mainnet.g.alchemy.com/nft/v2/docs-demo/computeRarity?contractAddress=0xe785E82358879F061BC3dcAC6f0444462D4b5330&tokenId=44")
  .asString();
```
...
var options = new RestClientOptions("https://eth-mainnet.g.alchemy.com/nft/v2/docs-demo/computeRarity?contractAddress=0xe785E82358879F061BC3dcAC6f0444462D4b5330&tokenId=44");
