...
> Source: [https://www.alchemy.com/docs/reference/nft-api-endpoints/nft-api-endpoints/nft-metadata-endpoints/get-nf-ts-for-contract-v-3.md](https://www.alchemy.com/docs/reference/nft-api-endpoints/nft-api-endpoints/nft-metadata-endpoints/get-nf-ts-for-contract-v-3.md)

# NFTs By Contract

> For the complete documentation index, see [llms.txt](/docs/llms.txt).

GET https://eth-mainnet.g.alchemy.com/nft/v3/{apiKey}/getNFTsForContract
...
Reference: https://www.alchemy.com/docs/reference/nft-api-endpoints/nft-api-endpoints/nft-metadata-endpoints/get-nf-ts-for-contract-v-3
...
```bash
curl --request GET \
  --url 'https://eth-mainnet.g.alchemy.com/nft/v3/docs-demo/getNFTsForContract?contractAddress=0xe785E82358879F061BC3dcAC6f0444462D4b5330'
```
...
fetch('https://eth-mainnet.g.alchemy.com/nft/v3/docs-demo/getNFTsForContract?contractAddress=0xe785E82358879F061BC3dcAC6f0444462D4b5330', options)
  .then(res => res.json())
...
```java
HttpResponse<String> response = Unirest.get("https://eth-mainnet.g.alchemy.com/nft/v3/docs-demo/getNFTsForContract?contractAddress=0xe785E82358879F061BC3dcAC6f0444462D4b5330")
  .asString();
```
...
var options = new RestClientOptions("https://eth-mainnet.g.alchemy.com/nft/v3/docs-demo/getNFTsForContract?contractAddress=0xe785E82358879F061BC3dcAC6f0444462D4b5330");
...
```yaml
path: /v3/{apiKey}/getNFTsForContract
method: GET
operation:
  summary: NFTs By Contract
