...
> Source: [https://www.alchemy.com/docs/internal-playbook-upgrading-ethereum-nodes.md](https://www.alchemy.com/docs/internal-playbook-upgrading-ethereum-nodes.md)

# Internal Playbook: Upgrading Ethereum Nodes

> Check out this internal playbook for why, when, and how we upgrade our Ethereum nodes for our users 🚀
