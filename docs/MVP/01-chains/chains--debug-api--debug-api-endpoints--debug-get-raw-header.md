...
> Source: [https://www.alchemy.com/docs/chains/debug-api/debug-api-endpoints/debug-get-raw-header.md](https://www.alchemy.com/docs/chains/debug-api/debug-api-endpoints/debug-get-raw-header.md)
...
const options = {
  ...
  body: JSON.stringify({jsonrpc: '2.0', id: 1, method: 'debug_getRawHeader', params: ['string']})
};
