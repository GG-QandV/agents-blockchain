...
> Source: [https://www.alchemy.com/docs/reference/alchemy-das-apis-for-solana/solana-das-api-endpoints/get-assets-by-creator.md](https://www.alchemy.com/docs/reference/alchemy-das-apis-for-solana/solana-das-api-endpoints/get-assets-by-creator.md)
...
Reference: https://www.alchemy.com/docs/reference/alchemy-das-apis-for-solana/solana-das-api-endpoints/get-assets-by-creator

## Parameters

| Name | Type | Required | Description |
|------|------|----------|-------------|
| creatorAddress | string | Yes | The creator address to filter by. |
| onlyVerified | boolean | No | Only return assets where the creator is verified. |
...
**Assets by creator** (object): Returns assets created by the specified address.
...
```json
{
  ...
  "params": [
    "9zsduBRp3VyGKaqim3b17dER3Z8fGCE1UYs4FNrqn1Km",
    {
      "sortBy": "created",
      "sortDirection": "asc"
    },
...
examples:
  - name: getAssetsByCreator example
    params:
      - name: creatorAddress
        value: 9zsduBRp3VyGKaqim3b17dER3Z8fGCE1UYs4FNrqn1Km
      - name: sortBy
        value:
          sortBy: created
          sortDirection: asc
