...
> Source: [https://www.alchemy.com/docs/reference/polygon-pos-api-faq.md](https://www.alchemy.com/docs/reference/polygon-pos-api-faq.md)

# Polygon PoS API FAQ

> Frequently asked questions about the Polygon API
