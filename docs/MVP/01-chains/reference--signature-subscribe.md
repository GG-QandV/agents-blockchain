...
> Source: [https://www.alchemy.com/docs/reference/signature-subscribe.md](https://www.alchemy.com/docs/reference/signature-subscribe.md)
...
<CodeGroup>
  ...
  > 📄 **This content also appears in [accountSubscribe](01-chains/reference--account-subscribe.md)** — see there for full details.
