...
> Source: [https://www.alchemy.com/docs/reference/alchemy-das-apis-for-solana/solana-das-api-endpoints/get-assets-by-authority.md](https://www.alchemy.com/docs/reference/alchemy-das-apis-for-solana/solana-das-api-endpoints/get-assets-by-authority.md)
...
Reference: https://www.alchemy.com/docs/reference/alchemy-das-apis-for-solana/solana-das-api-endpoints/get-assets-by-authority

## Parameters

| Name | Type | Required | Description |
|------|------|----------|-------------|
| authorityAddress | string | Yes | The authority address to filter by. |
...
**Assets by authority** (object): Returns assets filtered by the specified authority.
...
examples:
  - name: getAssetsByAuthority example
    params:
      - name: authorityAddress
        value: 2RtGg6fsFiiF1EQzHqbd66AhW7R5bWeQGpTbv2UMkCdW
      - name: sortBy
        value:
          sortBy: created
          sortDirection: asc
