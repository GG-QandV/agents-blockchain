...
> Source: [https://www.alchemy.com/docs/how-to-use-jwts-for-api-requests.md](https://www.alchemy.com/docs/how-to-use-jwts-for-api-requests.md)

# How To Use JWTs For API Requests

> Learn how to use JWTs ( JSON Web Tokens ) for making secure API requests with Alchemy.
