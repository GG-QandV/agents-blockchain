...
> Source: [https://www.alchemy.com/docs/how-to-get-a-contracts-first-transfer-event.md](https://www.alchemy.com/docs/how-to-get-a-contracts-first-transfer-event.md)

# How to Get a Contract's First Transfer Event

> Retrieve the earliest transfer event for a smart contract using Alchemy's SDK and the Transfers API.
