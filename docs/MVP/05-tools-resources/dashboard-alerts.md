...
> Source: [https://www.alchemy.com/docs/dashboard-alerts.md](https://www.alchemy.com/docs/dashboard-alerts.md)

# Dashboard Alerts

> Guide on setting up and managing dashboard alerts to monitor your app behavior and usage
