...
> Source: [https://www.alchemy.com/docs/how-to-get-a-contracts-last-transfer-event.md](https://www.alchemy.com/docs/how-to-get-a-contracts-last-transfer-event.md)

# How to Get a Contract's Last Transfer Event

> Retrieve the most recent transfer event for a smart contract using Alchemy's SDK and the Transfers API.
