...
> Source: [https://www.alchemy.com/docs/reference/rootstock-api-quickstart.md](https://www.alchemy.com/docs/reference/rootstock-api-quickstart.md)

# Rootstock API Quickstart

> How to get started building on Rootstock using Alchemy
