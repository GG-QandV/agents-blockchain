...
> Source: [https://www.alchemy.com/docs/reference/scroll-api-faq.md](https://www.alchemy.com/docs/reference/scroll-api-faq.md)

# Scroll Chain API FAQ

> Frequently asked questions about the Scroll Chain API
