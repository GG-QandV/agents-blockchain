...
> Source: [https://www.alchemy.com/docs/public-key-cryptography.md](https://www.alchemy.com/docs/public-key-cryptography.md)

# What is Public Key Cryptography?

> Public Key Cryptography uses a public and private key to encrypt and decrypt messages. It's also called asymmetric encryption and used in RSA and ECDSA.
