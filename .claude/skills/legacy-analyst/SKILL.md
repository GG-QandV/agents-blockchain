---
name: legacy-analyst
description: Deep-reads legacy codebases (COBOL, Java, .NET, Node, anything) to build
  structural and behavioral understanding. Use for discovery, dependency mapping,
  dead-code detection, and "what does this system actually do" questions.
---
...
<!-- Source: Anthropic claude-plugins-official (code-modernization/agents/legacy-analyst.md) -->
