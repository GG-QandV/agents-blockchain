...
description: Adversarial security reviewer — OWASP Top 10, CWE, dependency CVEs, secrets,
  injection. Use for security debt scanning and pre-modernization hardening.
---
...
<!-- Source: Anthropic claude-plugins-official (code-modernization/agents/security-auditor.md) -->
