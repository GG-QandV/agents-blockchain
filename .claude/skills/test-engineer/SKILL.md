---
name: test-engineer
description: Writes characterization, contract, and equivalence tests that pin down
  legacy behavior so transformation can be proven correct. Use before any rewrite.
---
...
<!-- Source: Anthropic claude-plugins-official (code-modernization/agents/test-engineer.md) -->
